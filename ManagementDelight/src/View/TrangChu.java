...
import Controller.BaoCaoPanel;
import Controller.DanhGiaPanel;
import Controller.DonHangPanel;
import Controller.KhachHangPanel;
import Controller.NhaCungCapPanel;
import Controller.NhanVienPanel;
import Controller.LoaiSPPanel;
import Controller.PhongBanPanel;
import Controller.TongQuanPanel;
...
public class TrangChu extends javax.swing.JFrame {
    ...
    public TrangChu() {
        initComponents();
        ImageIcon originalIcon = new ImageIcon(getClass().getResource("/Image/intro.png"));
        Image scaledImage = originalIcon.getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH);
        ImageIcon resizedIcon = new ImageIcon(scaledImage);

        jLabel1.setIcon(resizedIcon);

        ImageIcon originalIcon1 = new ImageIcon(getClass().getResource("/Image/logout.png"));
        ...
        lblDX.setIcon(resizedIcon1);
        cardLayout = new CardLayout();
        contentPanel.setLayout(cardLayout);
        contentPanel.add(new TongQuanPanel(), "TongQuan");
        ...
        contentPanel.add(new LoaiSPPanel(), "SanPham");
        contentPanel.add(new DonHangPanel(), "DonHang");
         contentPanel.add(new PhongBanPanel(), "PhongBan");
          contentPanel.add(new BaoCaoPanel(), "BaoCao");
          contentPanel.add(new DanhGiaPanel(), "DanhGia");
    }
    ...
    private void initComponents() {
        ...
        setTitle("Quản lý cửa hàng Delight");
        ...
        pnTongQuan.setBackground(new java.awt.Color(0, 102, 51));
        pnTongQuan.setForeground(new java.awt.Color(255, 255, 255));
        pnTongQuan.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnTongQuan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pnTongQuanMouseClicked(evt);
            }
        });
        ...
        jLabel9.setText("Quản lý đánh giá");
        ...
        jLabel11.setText("Quản lý phòng ban");
        ...
        jLabel10.setText("Thống kê & báo cáo");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(pnTongQuan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void pnTongQuanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnTongQuanMouseClicked
      cardLayout.show(contentPanel, "TongQuan");  // TODO add your handling code here:
    }//GEN-LAST:event_pnTongQuanMouseClicked
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        // TODO add your handling code here:
         cardLayout.show(contentPanel, "DonHang");
    }//GEN-LAST:event_jPanel5MouseClicked

    private void jPanel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel8MouseClicked
        // TODO add your handling code here:
         cardLayout.show(contentPanel, "DanhGia");
    }//GEN-LAST:event_jPanel8MouseClicked

    private void jPanel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel10MouseClicked
        // TODO add your handling code here:
        cardLayout.show(contentPanel, "PhongBan");
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        ...
        this.dispose(); // Đóng form hiện tại sau khi đăng xuất
    }
